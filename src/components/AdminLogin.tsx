      ...
      <div className="w-full max-w-md">
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {message && <div className="p-3 bg-green-500/20 border border-green-500/50 rounded-lg text-green-200 text-sm">{message}</div>}
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <p className="text-gray-400 text-sm text-center mb-3">First time here? Create your admin account</p>
            <button
            ...
            >
              {isCreatingAccount ? <><Loader2 size={20} className="animate-spin" /> Creating account...</> : <><UserPlus size={20} /> Create Admin Account</>}
            </button>
          </div>
        </div>
      </div>
